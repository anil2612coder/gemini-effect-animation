...
export default function Home() {
  ...
  const firstLine = useTransform(scrollYProgress, [0, 0.6], [0, 1]);
  const secondLine = useTransform(scrollYProgress, [0.2, 0.6], [0, 1]);
  const thirdLine = useTransform(scrollYProgress, [0.3, 0.6], [0, 1]);
  const forthLine = useTransform(scrollYProgress, [0.2, 0.6], [0, 1]);
